...
const char* mqtt_server = "INSERT MQTT ADDRESS";
const char* mqtt_username = "INSERT MQTT USER";
const char* mqtt_password = "INSERT MQTT PASSWORD";
...
const char* light_state_topic = "Bedroom/grono_Lamp";
const char* light_set_topic = "Bedroom/grono_Lamp/set";
